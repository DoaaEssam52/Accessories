  ...
  return (
    <>
      <div className="row Checkout">
        <div className="col-12 col-md-8 col-lg-6 Chechout__summarize">
          ...
          <h6 className="total-price">
            Total price is {Math.round(totalPrice * 100) / 100} L.E.
          </h6>
        </div>
        <div className="col-10 col-md-8 col-lg-4 Chechout__form">
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="row mx-0">
                ...
                <div className="col-12 col-md-6 Chechout__form__items">
